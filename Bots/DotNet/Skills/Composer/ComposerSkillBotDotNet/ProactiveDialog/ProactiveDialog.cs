...
{
    public class ProactiveDialog : Dialog
    {
        [JsonProperty("$kind")]
        public const string Kind = "ProactiveDialog";
        ...
        [JsonConstructor]
        public ProactiveDialog(IHttpContextAccessor httpContextAccessor, ConcurrentDictionary<string, ContinuationParameters> continuationParametersStore)
        {
            ...
            _serverUrl = new Uri(string.Empty);
        }
