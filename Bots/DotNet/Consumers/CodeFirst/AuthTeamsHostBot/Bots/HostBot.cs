...
namespace Microsoft.BotFrameworkFunctionalTests.SimpleHostBot.Bots
{
    public class HostBot : TeamsActivityHandler
    {
        ...
        {
            // Forward the activity to the skill
            var response = await _skillClient.PostActivityAsync(_botId, _targetSkill, _skillsConfig.SkillHostEndpoint, (Activity)turnContext.Activity, cancellationToken);
