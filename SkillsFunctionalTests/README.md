...
4. In the variables section add the following variables.
   ...
   | **RegistryUrlHost** <br> **RegistryUrlSkill**          | User                                                                                                                                              | The registry where the BotBuilder packages will be downloaded. <br><br> Available registry options: <ul><li>**C# (.Net)** <ul><li>**Empty:** MyGet</li><li>**MyGet**</li><li>**NuGet**</li><li>**Custom**</li></ul> </li><li>**JavaScript**<ul><li>**Empty:** MyGet</li><li>**MyGet**</li><li>**Npm**</li><li>**Custom**</li></ul></li> <li>**Python**<ul><li>**Empty:** Test.PyPi</li><li>**MyGet**</li><li>**PyPi**</li><li>**Test.PyPi**</li><li>**Custom**</li></ul> </li></ul> <br> **Custom** option only supports MyGet feeds.                                                                                                 | <ul><li>**optional**</li></ul>                      |
