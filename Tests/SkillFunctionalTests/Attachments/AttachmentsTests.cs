...
namespace SkillFunctionalTests.Attachments
{
    [Trait("TestCategory", "Attachments")]
    public class AttachmentsTests : ScriptTestBase
    {
        private readonly string _testScriptsFolder = Directory.GetCurrentDirectory() + @"/Attachments/SourceTestScripts";
        private readonly string _transcriptsFolder = Directory.GetCurrentDirectory() + @"/Attachments/SourceTranscripts";
